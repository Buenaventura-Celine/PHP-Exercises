...
<body>
    <?php  
        ...
        define("DESCRIPTION" , "Creating PHP Script");
    ...
    <div class = "navigation_section">
        ...
        <a href="lab2.php" class = "active"><i class="fa fa-desktop" aria-hidden="true"></i>Lab 2 -Creating Basic PHP Script</a>
